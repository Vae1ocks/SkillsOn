...
class AuthServiceTest(APITestCase):
    ...
    def test_registration_categories_choice_get(self):
        responses.add(
            responses.GET,
            "http://testserver/courses/category-list/",
            json=[
                {"id": 1, "title": "1st category"},
                {"id": 2, "title": "2nd category"},
                {"id": 3, "title": "3rd category"},
                {"id": 4, "title": "4th category"},
            ],
        )
    ...
    def test_registration_categories_choice_post(
        self, mock_requests_post, mock_send_task
    ):
        mock_requests_post.return_value.status_code = status.HTTP_200_OK
        mock_requests_post.return_value.json.return_value = [
            {"id": 1, "title": "DevOps"},
            {"id": 2, "title": "Веб-разработка"},
            {"id": 3, "title": "iOS-разработка"},
            {"id": 4, "title": "Android-разработка"},
        ]
        ...
        categories_liked_data = [{"id": 1}, {"id": 2}, {"id": 3}, {"id": 4}]
        url = reverse("authentication:registration_category_choice")
    ...
    def test_registration_categories_choice_post_data_incorrect(
        ...
        mock_requests_post.return_value.status_code = status.HTTP_400_BAD_REQUEST
        ...
        categories_liked_data = [
            {"id": 3654653, "title": "Invalid title"},
            {"id": 55555, "title": "Sample"},
            {"id": 3, "title": "3rd category"},
            {"id": 4, "title": "4th category"},
        ]
        url = reverse("authentication:registration_category_choice")
