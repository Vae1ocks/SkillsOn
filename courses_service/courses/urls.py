...
urlpatterns = [
    ...
    path('<slug:slug>/<int:pk>/', views.CourseViewSet.as_view({'get': 'retrieve',
                                                               ...
                                                               'delete': 'destroy'}),
                                                               name='course_detail'),
    path('<slug:slug>/<int:pk>/comment/create/', views.CourseCommentCreateView.as_view(),
         name='course_comment_create'),
    path('course-comment/<int:pk>/update/', views.CourseCommentUpdateView.as_view(),
    ...
    path('lesson-comment/<int:pk>/update/', views.LessonCommentUpdateView.as_view(),
         name='lesson_comment_update'),
    path('lesson-comment/<int:pk>/delete', views.LessonCommentDestroyView.as_view(),
